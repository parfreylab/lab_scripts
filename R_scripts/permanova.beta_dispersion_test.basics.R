...
res.adonis.rarefied <- adonis2(project_bray.rarefied ~ FACTOR1 + FACTOR2, data=sample_df, method="bray", by = "terms") #adding 'by = "terms"' to the parameters displays significance by each term tested. leaving this parameter out will show you the overall model signficance value
